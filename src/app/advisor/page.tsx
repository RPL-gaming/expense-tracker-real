              ...
              >
                ...
                >
                  <div
                    ...
                    data-tip={`The advisor ${advisor.name} has a ${similarity}% match to your prompt.`}
                  >
                    {similarity}%
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <p>
                    <strong>Experience:</strong> {advisor.yearsOfExperience}{" "}
                    years
                  </p>
                  <p>
                    <strong>Rate:</strong> IDR{" "}
                    {advisor.ratePerHour.toLocaleString("id-ID")} per hour
                  </p>
                  <p>{advisor.bio}</p>
